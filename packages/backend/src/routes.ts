...
import { OrderCreate, OrderUpdate, OrderConfirmDelivery } from './app/validators/OrderValidator'
...
routes.put('/order/:order_id/confirm', OrderConfirmDelivery, DeliveryOrderController.confirmDelivery)
